...
def test_create_get(test_db):
    ...
    response = client.post("/api/v1/items", json={"name": "Test Item", "description": "A test item", "price": 999})
    assert response.status_code == 200
    assert response.json() == {"id": 1, "name": "Test Item", "description": "A test item", "price": 999}
...
def test_list_two(test_db):
    ...
    response = client.post("/api/v1/items", json={"name": "Test Item", "description": "A test item", "price": 999})
    assert response.status_code == 200
    assert response.json() == {"id": 2, "name": "Test Item", "description": "A test item", "price": 999}
    response = client.get("/api/v1/items")
    assert response.status_code == 200
...
def test_update(test_db):
    ...
    assert response.status_code == 200
    assert response.json() == {"id": 1, "name": "Test Item", "description": "A test item", "price": 999}
    response = client.put("/api/v1/items/1", json={"name": "Updated Item", "description": "An updated test item", "price": 1999})
    assert response.status_code == 200
    assert response.json() == {"id": 1, "name": "Updated Item", "description": "An updated test item", "price": 1999}
    response = client.get("/api/v1/items/1")
    assert response.status_code == 200
    assert response.json() == {"id": 1, "name": "Updated Item", "description": "An updated test item", "price": 1999}
...
def test_update_missing(test_db):
    ...
    response = client.put("/api/v1/items/1", json={"name": "Test Item", "description": "A test item", "price": 999})
    assert response.status_code == 404
